        ...
        for yml_document in yml_document_all:
            ...
            if "List" in yml_document["kind"]:
                ...
                for yml_object in yml_document["items"]:
                    ...
                    try:
                        print type(yml_object)
                        print yml_object
                        create_from_yaml_single_item(k8s_client, yml_object, verbose, **kwargs)
                    except client.rest.ApiException as api_exception:
                        api_exceptions.append(api_exception)
            else:
                # This is a single object. Call the single item method
                try:
                    create_from_yaml_single_item(k8s_client, yml_document, verbose, **kwargs)
                except client.rest.ApiException as api_exception:
                    api_exceptions.append(api_exception)
